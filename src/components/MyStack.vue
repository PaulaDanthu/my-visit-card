<template>
    <div 
        ...
        <ul 
            ...
            tw-cursor-pointer
            ">
            <li v-for="technology in techArray" 
                :key="technology" 
